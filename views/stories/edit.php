...
<div class="detail-card">
  ...
  <div class="form-row">
    ...
    <div class="form-group"><label>Плановый хронометраж</label>
      <input type="text" name="estimated_duration" placeholder="00:03:00"
             value="<?=Input::e($story['estimated_duration']??'')?>"></div>
  </div>
</div>
